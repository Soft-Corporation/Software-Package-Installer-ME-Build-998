...
Public Class Gimp
    ...
    Private Sub Gimp_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_386ae55548b94068b59b355df5333e6d.zip"), TextBox1.Text)
        Timer1.Start()
