...
Public Class _7zip
    ...
    Private Sub _7zip_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_2c77d21f22c742a39a2db482edcc2949.zip"), TextBox2.Text)
