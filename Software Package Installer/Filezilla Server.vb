...
Public Class Filezilla_Server
    ...
    Private Sub Filezilla_Server_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        End If
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_6dd0e1cc93704655acda4fa466da1751.zip"), TextBox1.Text)
        ProgressBar1.Show()
