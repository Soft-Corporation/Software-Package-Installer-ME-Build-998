...
Public Class OpenOffice
    ...
    Private Sub OpenOffice_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_35f633409bf243cf911ef22acc943bdd.zip"), TextBox1.Text)
