...
Public Class Chrome_Canary
    ...
    Private Sub Chrome_Canary_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        save.FileName = "Chrome Canary"
        If save.ShowDialog = Windows.Forms.DialogResult.OK Then
            TextBox1.Text = save.FileName
        End If
        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_b5c062f647a3435aa88aa7e52a173fc1.zip"), TextBox1.Text)
        Timer1.Start()
