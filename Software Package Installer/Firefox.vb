...
Public Class Firefox
    ...
    Private Sub Firefox_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ProgressBar1.Show()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_c8f690c7146443e1932b3d37214eeffb.zip"), TextBox2.Text)
        Timer1.Start()
