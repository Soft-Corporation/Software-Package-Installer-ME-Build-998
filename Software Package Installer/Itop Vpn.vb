...
Public Class Itop_Vpn
    ...
    Private Sub Itop_Vpn_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_617233151b2341a190964565efccd504.zip"), TextBox1.Text)
