...
Public Class Visual
    ...
    Private Sub Vsc_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ProgressBar1.Show()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_38aa01a1acf7457187e368c4aa187398.zip"), TextBox2.Text)
        timer1.start
    End Sub
