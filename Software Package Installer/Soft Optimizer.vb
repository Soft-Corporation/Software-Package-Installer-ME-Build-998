...
Public Class Soft_Optimizer
    ...
    Private Sub Soft_Optimizer_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_a91917e7c6e14ec2bfc00e85a7a44697.zip"), TextBox1.Text)
