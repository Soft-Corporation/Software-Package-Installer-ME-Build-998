...
Public Class Virtualbox
    ...
    Private Sub Virtualbox_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_a02beeaf209d4cab84f09e675e006c9d.zip"), TextBox2.Text)
        Timer1.Start()
