...
Public Class Opera_Gx
    ...
    Private Sub Opera_Gx_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_254221853713445cbb4a0334a4de759d.zip"), TextBox1.Text)
        Timer1.Start()
