...
Public Class Crystaldiskmark
    ...
    Private Sub Crystaldiskmark_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_caa41b7074eb425e86583c973edb4d09.zip"), TextBox1.Text)
        Timer1.Start()
