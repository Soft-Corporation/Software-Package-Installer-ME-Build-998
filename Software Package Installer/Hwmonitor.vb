...
Public Class Hwmonitor
    ...
    Private Sub Hwmonitor_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_ca3b2f7ebfd04c29b979d62f67f4d7a1.zip"), TextBox2.Text)
        Timer1.Start()
